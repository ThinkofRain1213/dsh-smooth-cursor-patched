window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:src/client/CursorControls.module.css.mjs
		const css = ".GHZmtq_panel{flex-direction:column;gap:12px;display:flex}.GHZmtq_item{align-items:center;gap:12px;display:flex}.GHZmtq_itemText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.GHZmtq_itemTitle{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:400;line-height:20px}.GHZmtq_itemDesc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.GHZmtq_itemControl{flex:none;align-items:center;gap:6px;display:flex}.GHZmtq_switch{cursor:pointer;display:inline-flex}.GHZmtq_switchInput{clip:rect(0 0 0 0);border:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}.GHZmtq_switchTrack{box-sizing:border-box;corner-shape:round;background:var(--dsw-alias-border-l3);border:0;border-radius:999px;align-items:center;width:36px;height:20px;padding:2px;transition:background .12s;display:inline-flex}.GHZmtq_switchThumb{corner-shape:round;background:var(--dsw-alias-label-primary-foreground);border-radius:50%;width:16px;height:16px;transition:transform .12s;display:block;transform:translate(0)}.GHZmtq_switchInput:checked+.GHZmtq_switchTrack{background:var(--dsw-alias-brand-primary)}.GHZmtq_switchInput:checked+.GHZmtq_switchTrack .GHZmtq_switchThumb{transform:translate(16px)}.GHZmtq_switchInput:focus-visible+.GHZmtq_switchTrack{outline:var(--dsw-focus-ring-width) solid var(--dsw-focus-ring-color,var(--dsw-alias-state-business-primary));outline-offset:2px}.GHZmtq_swatches{flex-wrap:wrap;justify-content:flex-end}.GHZmtq_swatch{border:1px solid var(--dsw-alias-border-l2);box-sizing:border-box;cursor:pointer;border-radius:50%;width:24px;height:24px;padding:0;position:relative}.GHZmtq_swatchActive{border-color:var(--dsw-alias-label-primary);outline:2px solid color-mix(in srgb, var(--dsw-alias-brand-primary) 40%, transparent);outline-offset:1px}.GHZmtq_customSwatch{cursor:pointer;justify-content:center;align-items:center;display:inline-flex;overflow:hidden}.GHZmtq_colorInput{opacity:0;cursor:pointer;width:100%;height:100%;position:absolute;inset:0}.GHZmtq_customOverlay{color:var(--dsw-alias-label-secondary);pointer-events:none;font-size:12px;line-height:1}.GHZmtq_sizeOption{border:1px solid var(--dsw-alias-border-l2);height:28px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:14px;padding:0 12px;font-size:12px;line-height:20px}.GHZmtq_sizeOption:hover:not(.GHZmtq_sizeActive){background:var(--dsw-alias-interactive-bg-hover)}.GHZmtq_sizeActive{background:var(--dsw-alias-bg-module-platform);border-color:var(--dsw-static-neutral-bluish-400)}";
		const tagId = "dsh-smooth-cursor-patched/CursorControls.module.css";
		...
		var CursorControls_module_css_default = {
			"colorInput": "GHZmtq_colorInput",
			"customOverlay": "GHZmtq_customOverlay",
			"customSwatch": "GHZmtq_customSwatch",
			"item": "GHZmtq_item",
			"itemControl": "GHZmtq_itemControl",
			"itemDesc": "GHZmtq_itemDesc",
			"itemText": "GHZmtq_itemText",
			"itemTitle": "GHZmtq_itemTitle",
			"panel": "GHZmtq_panel",
			"sizeActive": "GHZmtq_sizeActive",
			"sizeOption": "GHZmtq_sizeOption",
			"swatch": "GHZmtq_swatch",
			"swatchActive": "GHZmtq_swatchActive",
			"swatches": "GHZmtq_swatches",
			"switch": "GHZmtq_switch",
			"switchInput": "GHZmtq_switchInput",
			"switchThumb": "GHZmtq_switchThumb",
			"switchTrack": "GHZmtq_switchTrack"
		};
		//#endregion
		//#region src/client/CursorControls.tsx
		function Switch({ checked, onChange, label }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
				className: CursorControls_module_css_default.switch,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
					type: "checkbox",
					className: CursorControls_module_css_default.switchInput,
					checked,
					onChange: (event) => {
					...
					className: CursorControls_module_css_default.switchTrack,
					"aria-hidden": "true",
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: CursorControls_module_css_default.switchThumb })
				})]
			});
		}
		/** Render the caret preference rows, without any surrounding section chrome. */
		function CursorControls({ t, useCursor, setEnabled, setTrail, setBlink, setColor, setSize }) {
			const settings = useCursor((state) => state.settings);
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: CursorControls_module_css_default.item,
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						className: CursorControls_module_css_default.itemText,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: CursorControls_module_css_default.itemTitle,
							children: t("cursor.title")
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: CursorControls_module_css_default.itemDesc,
							children: t("cursor.titleDescription")
						})]
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: CursorControls_module_css_default.itemControl,
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						className: `${CursorControls_module_css_default.itemControl} ${CursorControls_module_css_default.swatches}`,
						role: "radiogroup",
						"aria-label": t("cursor.color"),
						children: [CURSOR_COLOR_SWATCHES.map((color) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							className: `${CursorControls_module_css_default.swatch} ${settings.color === color ? CursorControls_module_css_default.swatchActive : ""}`,
							...
							className: `${CursorControls_module_css_default.swatch} ${CursorControls_module_css_default.customSwatch}`,
							title: t("cursor.customColor"),
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
								type: "color",
								className: CursorControls_module_css_default.colorInput,
								...
								className: CursorControls_module_css_default.customOverlay,
								"aria-hidden": "true",
								children: "…"
							})]
						})]
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						children: CURSOR_SIZES.map((size) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							className: `${CursorControls_module_css_default.sizeOption} ${settings.size === size ? CursorControls_module_css_default.sizeActive : ""}`,
							role: "radio",
		...
		//#endregion
		//#region src/client/CursorPanel.tsx
		/** Render the caret configuration body on the bundle's Plugins page. */
		function CursorPanel({ view, ...controls }) {
			if (view !== "page") return null;
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: CursorControls_module_css_default.panel,
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CursorControls, { ...controls })
			});
		}
		//#endregion
...
`;
		...
		*/
		function measureRichCaret(host) {
			...
			*/
			const caretBlock = (node) => {
				let el = node === null ? null : node instanceof Element ? node : node.parentElement;
				while (el !== null && el !== host) {
					const display = window.getComputedStyle(el).display;
					if (display === "block" || display === "list-item" || display === "flex") return el instanceof HTMLElement ? el : host;
					el = el.parentElement;
				}
				return host;
			};
			...
			*/
			...
			const br = (startEl instanceof HTMLElement && host.contains(startEl) && startEl !== host ? startEl : caretBlock(selection.focusNode)).querySelector("br");
			if (br !== null) {
		...
		*/
		var CursorEngine = class {
			...
			*/
			ownerToken = Math.random().toString(36).slice(2);
			raf = 0;
			...
			*/
			...
			renderOnce() {
				...
				if (this.style !== void 0 && !this.style.isConnected) {
					document.head.appendChild(this.style);
					const root = document.documentElement;
