window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:src/client/CursorRow.module.css.mjs
		const css = "._7I5z-W_group{border-bottom:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:12px;padding:16px 0;display:flex}._7I5z-W_titleRow{align-items:center;gap:8px;display:flex}._7I5z-W_title{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}._7I5z-W_titleText{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}._7I5z-W_titleDesc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}._7I5z-W_item{align-items:center;gap:12px;display:flex}._7I5z-W_itemText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}._7I5z-W_itemTitle{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:400;line-height:20px}._7I5z-W_itemDesc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}._7I5z-W_itemControl{flex:none;align-items:center;gap:6px;display:flex}._7I5z-W_switch{cursor:pointer;display:inline-flex}._7I5z-W_switchInput{clip:rect(0 0 0 0);border:0;width:1px;height:1px;margin:-1px;padding:0;position:absolute;overflow:hidden}._7I5z-W_switchTrack{box-sizing:border-box;background:var(--dsw-alias-bg-module-platform);border:1px solid var(--dsw-alias-border-l2);border-radius:10px;align-items:center;width:36px;height:20px;padding:2px;transition:background .16s,border-color .16s;display:inline-flex}._7I5z-W_switchThumb{background:var(--dsw-alias-label-secondary);border-radius:50%;width:14px;height:14px;transition:transform .16s,background .16s;display:block;transform:translate(0)}._7I5z-W_switchInput:checked+._7I5z-W_switchTrack{background:var(--dsw-alias-brand-primary);border-color:#0000}._7I5z-W_switchInput:checked+._7I5z-W_switchTrack ._7I5z-W_switchThumb{background:var(--dsw-static-neutral-bluish-50);transform:translate(16px)}._7I5z-W_switchInput:focus-visible+._7I5z-W_switchTrack{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:2px}._7I5z-W_swatches{flex-wrap:wrap;justify-content:flex-end}._7I5z-W_swatch{border:1px solid var(--dsw-alias-border-l2);box-sizing:border-box;cursor:pointer;border-radius:50%;width:24px;height:24px;padding:0;position:relative}._7I5z-W_swatchActive{border-color:var(--dsw-alias-label-primary);outline:2px solid color-mix(in srgb, var(--dsw-alias-brand-primary) 40%, transparent);outline-offset:1px}._7I5z-W_customSwatch{cursor:pointer;justify-content:center;align-items:center;display:inline-flex;overflow:hidden}._7I5z-W_colorInput{opacity:0;cursor:pointer;width:100%;height:100%;position:absolute;inset:0}._7I5z-W_customOverlay{color:var(--dsw-alias-label-secondary);pointer-events:none;font-size:12px;line-height:1}._7I5z-W_sizeOption{border:1px solid var(--dsw-alias-border-l2);height:28px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:14px;padding:0 12px;font-size:12px;line-height:20px}._7I5z-W_sizeOption:hover:not(._7I5z-W_sizeActive){background:var(--dsw-alias-interactive-bg-hover)}._7I5z-W_sizeActive{background:var(--dsw-alias-bg-module-platform);border-color:var(--dsw-static-neutral-bluish-400)}";
		...
		var CursorRow_module_css_default = {
			"colorInput": "_7I5z-W_colorInput",
			"customOverlay": "_7I5z-W_customOverlay",
			"customSwatch": "_7I5z-W_customSwatch",
			"group": "_7I5z-W_group",
			"item": "_7I5z-W_item",
			"itemControl": "_7I5z-W_itemControl",
			"itemDesc": "_7I5z-W_itemDesc",
			"itemText": "_7I5z-W_itemText",
			"itemTitle": "_7I5z-W_itemTitle",
			"sizeActive": "_7I5z-W_sizeActive",
			"sizeOption": "_7I5z-W_sizeOption",
			"swatch": "_7I5z-W_swatch",
			"swatchActive": "_7I5z-W_swatchActive",
			"swatches": "_7I5z-W_swatches",
			"switch": "_7I5z-W_switch",
			"switchInput": "_7I5z-W_switchInput",
			"switchThumb": "_7I5z-W_switchThumb",
			"switchTrack": "_7I5z-W_switchTrack",
			"title": "_7I5z-W_title",
			"titleDesc": "_7I5z-W_titleDesc",
			"titleRow": "_7I5z-W_titleRow",
			"titleText": "_7I5z-W_titleText"
		};
		//#endregion
